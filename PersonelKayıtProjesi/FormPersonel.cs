    ...
    public partial class FormPersonel : Form
    {
        ...
        private void btngiris_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (reader.Read())
                {
                    FormAnaPer formAnaper = new FormAnaPer();

                    formAnaper.Show();
                    this.Hide();

                    //ozel
                    FormAnaPer formana = Application.OpenForms["FormAnaPer"] as FormAnaPer;
                    FormGiris formgiris = Application.OpenForms["FormGiris"] as FormGiris;
        ...
        {
            FormGiris formGrs = Application.OpenForms["FormGiris"] as FormGiris;
            if (formGrs != null)
            {
                formGrs.Focus();
                formGrs.Show();
